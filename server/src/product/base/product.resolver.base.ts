...
import { Catagory } from "../../catagory/base/Catagory";
...
export class ProductResolverBase {
  ...
  async createProduct(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        catagory: args.data.catagory
          ? {
              connect: args.data.catagory,
            }
          : undefined,
  ...
  async resolveFieldCatagory(
    @graphql.Parent() parent: Product
  ): Promise<Catagory | null> {
    const result = await this.service.getCatagory(parent.id);
